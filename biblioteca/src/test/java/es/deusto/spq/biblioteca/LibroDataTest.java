...
public class LibroDataTest {
	...
	public void setUp() throws Exception {
		...
		L2 = new Libro("2", "Libro 2", "Autor 2", "Editorial 2");
		L3 = new Libro("3", "Libro 3", "Autor 3", "Editorial 3");
		L4 = new Libro("4", "Libro 4", "Autor 4", "Editorial 4");
	...
	public void testCreacionLibro() throws Exception {
		Libro expected = new Libro("1", "Libro 1", "Autor 1", "Editorial 1");
	...
	public void testCreacionLibro4() throws Exception {
		...
		Libro expected = new Libro("4", "Libro 4", "Autor 4", "Editorial 4");
