...
public class LibroDataTest {
	...
	public void setUp() throws Exception {
		...
		L5 = new Libro("5", "Libro 5", "Autor 5", "Editorial 5");
...
//	}
	...
	@Test 
    @PerfTest(invocations = 10, threads = 30, duration = 1000)
    @Required(max = 1000, average = 200, throughput = 10)
	public void testCreacionLibro5() throws Exception {
		
		logger.info("Iniciando test de creacion del primer libro y anyadido de premio");
		
		Libro expected = new Libro("5", "Libro 5", "Autor 5", "Editorial 5");
		assertEquals(expected.getIsbn(), L5.getIsbn());
		assertEquals(expected.getnombre(), L5.getnombre());
		assertEquals(expected.getAutor(), L5.getAutor());
		assertEquals(expected.getEditorial(), L5.getEditorial());
		expected.setPremio("Best Seller");
		L5.setPremio("Best Seller");
		assertEquals(expected.getPremio(), L5.getPremio());
		logger.info("Fin de test de creacion del quinto libro");
