...
/**
 * Clase de creación de ventana reserva ibro
 * Estructura realizada por
 * @author Jon Martinez
 * Fondo y funcionalidad del controller implementado por
 * @author Ariane
 */
public class VentanaHacerReservaLibro extends JFrame {
	 ...
	 */
	public VentanaHacerReservaLibro(Controller controller) {
	...
	public void ventana() {
		...
		button.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				VentanaHacerReservaLibro.this.dispose();
	...
	public void ejecutarVentana() {
		try {
			final VentanaHacerReservaLibro Ventana = new VentanaHacerReservaLibro(controller);
